# ROOT-REFERENCE-LEGAL  
## Structural Legal Reference Repository

**TAG:** root-reference-legal_v1  
**REALM:** ROOT-REFERENCE  
...
- `root-legal-notice_reference.md`  
  Structural description of the ROOT Legal Notice (reference)
...
### Placement
This repository is part of the ROOT‑REFERENCE realm and must not be merged with DEMO, GDR, QR, CODEX, MATRIX, or ROOT itself.

### Integrity Statement
This repository maintains structural fidelity while preserving the immutability and non‑reproducibility of ROOT instruments. It exists for documentation, archival clarity, and realm‑safe reference.
